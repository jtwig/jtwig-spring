...
import org.jtwig.spring.config.prefix.WebWithPrefixConfig;
...
public class JtwigViewResolverWithCustomPrefixIntegrationTest {
    ...
    private static WebApplicationContext getContext() {
        ...
        context.setConfigLocation(WebWithPrefixConfig.class.getPackage().getName());
        return context;
    }
