...
import org.jtwig.spring.config.custom.WebWithCustomRenderConfig;
...
public class JtwigViewResolverWithCustomRendererIntegrationTest {
    ...
    private static WebApplicationContext getContext() {
        ...
        context.setConfigLocation(WebWithCustomRenderConfig.class.getPackage().getName());
        return context;
    }
